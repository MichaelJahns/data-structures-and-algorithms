...
const extractStats = (arr) => {
    const abilArray = [];
      arr.map((n, i) => {
        abilArray.push({name: n.stat.name, total: n.effort+n.baseStat})
      })
      return abilArray
  };
