...
const getStatName = (arr, minBaseStat) => {
  ...
  arr.filter((n) => {
    if(n.baseStat > minBaseStat){
      greaterThanMax.push(n.stat.name)
    }
  })
